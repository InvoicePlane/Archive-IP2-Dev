    ...
    <table class="table table-striped">
        ...
        <?php foreach ($quotes as $quote) { ?>
            <tr>
                <td>
                    <span
                        class="label <?php echo $quote_statuses[$quote->status_id]['class']; ?>"><?php echo $quote_statuses[$quote->status_id]['label']; ?></span>
                </td>
                <td>
                    <a href="<?php echo site_url('quotes/view/' . $quote->id); ?>"
                       title="<?php echo lang('edit'); ?>">
                        <?php echo $quote->number; ?>
                    </a>
                </td>
                <td>
                    <?php echo date_from_mysql($quote->date_created); ?>
                </td>
                <td>
                    <?php echo date_from_mysql($quote->date_expires); ?>
                </td>
                <td>
                ...
                <td style="text-align: right; padding-right: 25px;">
                    <?php echo format_currency($quote->total); ?>
                </td>
                <td>
                    <div class="options btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('quotes/generate_pdf/' . $quote->id); ?>"
                                   target="_blank">
                                    <i class="fa fa-print fa-margin"></i> <?php echo lang('download_pdf'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('mailer/quote/' . $quote->id); ?>">
                                    <i class="fa fa-send fa-margin"></i> <?php echo lang('send_email'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('quotes/delete/' . $quote->id); ?>"
